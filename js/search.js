...
import { resetUI } from "./memory.js?v=1.4.10";
import { initCode } from "./code.js?v=1.4.10";
...
export async function transitionToCode() {
  ...
  const { resumeSudokuState } = await import("./sudoku.js?v=1.4.10");
  const { resumePeaksState } = await import("./peaks.js?v=1.4.10");
  const { resumeCodeState } = await import("./code.js?v=1.4.10");
