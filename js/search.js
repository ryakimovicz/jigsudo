...
import { resetUI } from "./memory.js?v=1.4.11";
import { initCode } from "./code.js?v=1.4.11";
...
export async function transitionToSearch() {
  ...
  const { resumeSudokuState } = await import("./sudoku.js?v=1.4.11");
  const { resumePeaksState } = await import("./peaks.js?v=1.4.11");
  resumeSudokuState();
  resumePeaksState();
}
...
export async function transitionToCode() {
  ...
  const { resumeSudokuState } = await import("./sudoku.js?v=1.4.11");
  const { resumePeaksState } = await import("./peaks.js?v=1.4.11");
  const { resumeCodeState } = await import("./code.js?v=1.4.11");
