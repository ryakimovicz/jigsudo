import { db, functions } from "./firebase-config.js?v=1.3.8";
import {
  doc,
  setDoc,
  getDoc,
...
import { getJigsudoDateString, getJigsudoYearMonth } from "./utils/time.js?v=1.3.8";
...
export async function saveUserStats(userId, statsData, username = null, options = {}) {
  ...
  try {
    ...
    const { auth } = await import("./firebase-config.js?v=1.3.8");
