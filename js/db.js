import { db, functions } from "./firebase-config.js?v=1.2.0";
import {
  doc,
  setDoc,
  getDoc,
...
import { getJigsudoDateString, getJigsudoYearMonth } from "./utils/time.js?v=1.2.0";
...
export async function saveUserStats(userId, statsData, username = null, metadataOnly = false) {
  ...
  try {
    ...
    const { auth } = await import("./firebase-config.js?v=1.2.0");
