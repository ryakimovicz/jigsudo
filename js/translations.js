export const translations = {
  es: {
    ...
    changelog_v120_item3: "Mantenimiento Proactivo: Centralización de la lógica de penalización (Decay) en el servidor; los puntos se ajustan al instante al iniciar sesión, actuando como red de seguridad si el proceso diario programado se retrasa.",
  ...
  en: {
    ...
    changelog_v120_item3: "Proactive Maintenance: Centralized penalty logic (Decay) on the server; points are adjusted instantly upon login, acting as a safety net if the daily scheduled process is delayed.",
