export const translations = {
  es: {
    ...
    about_github_text: "Jigsudo es un proyecto transparente. Si eres desarrollador o tienes curiosidad por cómo funciona por dentro, puedes revisar todo el código fuente en <a href=\"https://github.com/ryakimovicz/jigsudo\" target=\"_blank\" class=\"faq-link\">GitHub</a> e incluso proponer mejoras.",
    about_demo_note_title: "Nota sobre la Edición Básica",
    about_demo_note_p: "Esta es la Edición Básica de Jigsudo. En esta versión, puedes probar el juego completo utilizando un puzle predeterminado. El sistema de desafíos diarios dinámicos está desactivado, pero todas las mecánicas de juego están presentes para que puedas experimentar la experiencia Jigsudo.",
  ...
  en: {
    ...
    seo_faq_3_q: "Where do I play the full version?",
    seo_faq_3_a: "You can access the full experience with global rankings, user profiles, and unlimited daily challenges at <a href='https://jigsudo.com' target='_blank' class='faq-link'>Jigsudo.com</a>.",
    seo_faq_4_q: "Is my progress saved?",
    seo_faq_4_a: "Yes! Your progress and history are saved locally in this browser. Keep in mind that if you clear the site data, the demo progress will be lost.",
    ...
    about_github_text: "Jigsudo is a transparent project. If you're a developer or curious about how it works under the hood, you can review all the source code on <a href=\"https://github.com/ryakimovicz/jigsudo\" target=\"_blank\" class=\"faq-link\">GitHub</a> and even propose improvements.",
    about_demo_note_title: "Basic Edition Note",
    about_demo_note_p: "This is the Basic Edition of Jigsudo. In this version, you can test the full game using a predetermined puzzle. The dynamic daily challenge system is deactivated, but all game mechanics are present so you can experience the Jigsudo journey.",
