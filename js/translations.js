export const translations = {
  es: {
    ...
    privacy_intro_text: "Tu privacidad es importante para mí. Esta Política de Privacidad explica cómo recopilo, uso y protejo tu información cuando utilizas nuestra aplicación web.",
    ...
    privacy_sec5_p2: "Para consultas adicionales sobre tus datos, puedes contactarme a través de mi página de contacto.",
    support_title: "Apoya el Proyecto",
    support_desc: "Si disfrutas de Jigsudo y quieres que siga siendo gratuito y sin publicidad, puedes invitarme un café.",
    ...
    seo_faq_8_a: "Jigsudo no tiene micro-pagos y el acceso es gratuito. El proyecto se mantiene de forma independiente, no contiene publicidad y acepto donaciones opcionales para sustentar los costos.",
  ...
  en: {
    ...
    privacy_intro_text: "Your privacy is important to me. This Privacy Policy explains how I collect, use, and protect your information when you use our web application.",
    ...
    privacy_sec5_p2: "For additional inquiries about your data, you can contact me through the contact section.",
    support_title: "Support the Project",
    support_desc: "If you enjoy Jigsudo and want to keep it free and ad-free, you can buy me a coffee.",
    support_argentina: "Argentina (MP)",
    support_global: "Global (PayPal)",
    ...
    seo_faq_8_a: "Jigsudo has no micro-payments and access is free. The project is maintained independently, contains no advertising, and I accept optional donations to support the costs.",
