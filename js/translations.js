export const translations = {
  es: {
    ...
    seo_faq_8_a: "Jigsudo no tiene micro-pagos y el acceso es gratuito. El proyecto se mantiene de forma independiente, no contiene publicidad y acepto donaciones opcionales para sustentar los costos, lo cual agradezco enormemente.",
  ...
  en: {
    ...
    seo_faq_8_a: "Jigsudo has no micro-payments and access is free. The project is maintained independently, contains no advertising, and I accept optional donations to support the costs, which I truly appreciate.",
