export const translations = {
  es: {
    ...
    changelog_v1114_item1: "Caché Inteligente Avanzada: Se ha corregido la discrepancia que causaba que la fila de usuario apareciera fuera de posición debido a una caché local desactualizada tras una victoria.",
    changelog_v1114_item2: "Persistencia de Identidad: Se ha mejorado la recuperación del nombre de usuario y UID durante la carga inicial para garantizar información correcta desde el primer renderizado.",
  ...
  en: {
    ...
    changelog_v1114_date: "08/04/2026",
    changelog_v1114_item1: "Advanced Smart Cache: Fixed discrepancy where the user row appeared out of position due to stale local cache after a victory.",
    changelog_v1114_item2: "Identity Persistence: Improved username and UID recovery during initial load to ensure correct identifying information from the first render.",
