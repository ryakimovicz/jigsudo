export const translations = {
  es: {
    ...
    sidebar_search_users: "Buscar Usuarios",
    search_users_title: "Buscar Jugadores",
    search_users_placeholder: "Escribe un nombre...",
    ...
    profile_career_score: "Puntaje Carrera",
    ...
    about_author_text: "Me llamo Román Yakimovicz, de Argentina, y soy Técnico Universitario en Programación. Jigsudo es el resultado de mi pasión por los acertijos, el desarrollo web y mi constante curiosidad por explorar nuevos desafíos. Fuera del código, me apasionan los cómics de DC, mi personaje favorito es Flash, y disfruto ver series, escuchar música y los videojuegos con amigos.",
    ...
    privacy_sec2_h: "1.2. Datos de Juego",
    ...
    privacy_sec3_h: "2. Cookies y Almacenamiento Local",
    privacy_sec3_p: "Se utiliza LocalStorage para guardar tus preferencias (Tema, Sonido, Vibración) y mantener tu sesión iniciada. Aunque Jigsudo no utiliza cookies propias para fines publicitarios, servicios de terceros esenciales (como Google Firebase o Google Tag Manager) pueden utilizar cookies técnicas necesarias para la seguridad, autenticación y análisis básico de rendimiento.",
    privacy_sec4_h: "3. Donaciones y Servicios de Terceros",
    ...
    privacy_sec5_h: "4. Tus Derechos",
    privacy_sec5_p1: "Tienes derecho a acceder, rectificar, limitar o eliminar tu información personal, así como a solicitar la portabilidad de tus datos. Puedes realizar la mayoría de estas acciones directamente desde la configuración de tu perfil. Para cualquier otra solicitud relacionada con tus derechos de privacidad, puedes contactarnos en <strong>support@jigsudo.com</strong>.",

    // Cookie Consent
    cookies_title: "Configuración de Cookies 🍪",
    cookies_text: "Utilizamos cookies técnicas y analíticas para mejorar tu experiencia y la seguridad del sitio.",
    cookies_btn_accept: "Aceptar todas",
    cookies_btn_deny: "Solo técnicas",
    cookies_link_policy: "Política de Privacidad",
    ...
    terms_sec7_h: "7. Modificaciones y Ley Aplicable",
    terms_sec7_p: "Nos reservamos el derecho de modificar estos términos en cualquier momento. El uso continuado del sitio tras los cambios implica su aceptación. Estos términos se rigen por las leyes de Argentina.",
    ...
    support_title_page: "Centro de Soporte",
    support_intro: "¿Necesitas ayuda con tu cuenta, encontraste un error o quieres enviarnos una sugerencia? Estamos aquí para escucharte.",
    support_github_title: "Reportar Errores y Sugerencias",
    support_github_desc: "Si eres usuario de GitHub, puedes abrir un reporte técnico (issue) directamente en nuestro repositorio de desarrollo. Es la forma más rápida de que veamos un error o una propuesta de mejora pública.",
    support_github_btn: "🛠️ Abrir Reporte en GitHub",
    support_email_title: "Consultas Privadas y Cuentas",
    support_email_desc: "Para problemas relacionados con tu cuenta, recuperación de datos, temas de privacidad o si prefieres contactarnos de forma privada, escríbenos a:",
    support_email_btn: "✉️ Enviar un Correo",
    support_donate_title: "¿Quieres apoyar el proyecto?",
    support_donate_desc: "Jigsudo es y será siempre gratuito. Si te gusta el desafío y quieres ayudarnos con los costos del servidor, puedes invitarnos un café.",
    ...
    btn_jigsaw_undo: "Deshacer",
    btn_jigsaw_redo: "Rehacer",
    ...
    stat_points: "Puntos",
    stats_details_title: "Promedios por nivel",
    ...
    changelog_v1423_title: "Versión 1.4.23",
    changelog_v1423_date: "14/06/2026",
    changelog_v1423_item1: "Sincronización: Se implementó un escudo anti-regresión para evitar que jugar en dispositivos desactualizados sobrescriba o reduzca los puntos de rango (RP) o estadísticas con valores menores.",
    changelog_v1422_title: "Versión 1.4.22",
    changelog_v1422_date: "31/05/2026",
    changelog_v1422_item1: "Puntos de Rango (RP): Se corrigió una condición de carrera durante la validación de victoria que provocaba una doble suma de +1.0 RP en perfiles y clasificaciones al terminar el puzzle.",
    changelog_v1421_title: "Versión 1.4.21",
    changelog_v1421_date: "26/05/2026",
    changelog_v1421_item1: "El Código: Se implementó un control de rebote en los clics para evitar el error de doble disparo táctil en celulares.",
    changelog_v1421_item2: "Puntos de Rango (RP): Se corrigió la inconsistencia en el sanador que igualaba totalRP a monthlyRP, forzando la reconstrucción desde el historial.",
    changelog_v1421_item3: "Estadísticas del Perfil: Se corrigió la obtención de stageTimes para calcular promedios históricos en base a datos de victoria reales.",
    changelog_v1421_item4: "Calendario e Historial: Se unificó la validación del estado de victoria para evitar que días ganados se muestren grises u opacos.",
    changelog_v1421_item5: "Rompecabezas: El botón de reinicio ahora mantiene colocadas las piezas bloqueadas en el tablero y devuelve las no bloqueadas a su posición inicial en el panel.",
    changelog_v1420_title: "Versión 1.4.20",
    changelog_v1420_date: "22/05/2026",
    changelog_v1420_item1: "Sincronización Atómica: Corrección de condición de carrera en dailyRP mediante verificación atómica y ajuste de deriva.",
    changelog_v1419_title: "Versión 1.4.19",
    changelog_v1419_date: "19/05/2026",
    changelog_v1419_item1: "Historial: Se corrigió la coloración de días jugados tardíamente desde el historial, asegurando que permanezcan en gris/amarillo y solo muestren la corona.",
    changelog_v1418_title: "Versión 1.4.18",
    changelog_v1418_date: "19/05/2026",
    changelog_v1418_item1: "Estabilidad de Puntos: Se resolvió el desajuste de 1 punto local al asegurar que el punto de la etapa final ('Código') se asigne antes del resumen de victoria.",
    changelog_v1418_item2: "Seguridad: Corrección de error de inicialización en el escudo del trono para evitar valores erróneos (NaN).",
    changelog_v1418_item3: "Historial y Perfil: Se corrigió la coloración (verde/amarillo) de partidas antiguas en los calendarios al reconocer registros legacy.",
    changelog_v1417_title: "Versión 1.4.17",
    changelog_v1417_date: "15/05/2026",
    changelog_v1417_item1: "Estabilidad: Refuerzo del reinicio de tablero (Rompecabezas) para garantizar que siempre vuelva al estado inicial real, incluso tras reanudar sesiones.",
    changelog_v1417_item2: "Seguridad: Implementación de guardias de interacción para evitar que los eventos del tutorial interfieran con el juego activo.",
    ...
    changelog_v149_item3: "Hotfix: Corregido error que arrastraba el puntaje de ayer al día de hoy durante el reseteo automático.",
    ...
    changelog_v141_item2: "Penalizaciones: Se corrigieron las penalizaciones por inactividad en perfiles antiguos.",
    changelog_v141_item3: "Comparativas: Mejoras en la visualización de comparaciones entre perfiles.",
    changelog_v141_item4: "Anclaje de Diseño: Estabilización del diseño vertical: los títulos y el tablero ahora mantienen una posición fija.",
    changelog_v141_item5: "Ayuda Dinámica: Se corrigieron los tooltips de ayuda en los niveles de Picos y Sopa de Números.",
    changelog_v141_item6: "Limpieza UI: Corrección de errores visuales en pantallas de alta resolución.",
    changelog_v140_title: "Versión 1.4.0 - El Gran Salto Analítico",
    changelog_v140_date: "22/04/2026",
    ...
    changelog_v1310_item2: "Mejoras en el Rompecabezas: nuevo botón de reinicio y animaciones de intercambio de piezas.",
    changelog_v1310_item3: "Nueva mecánica en Sudoku: ahora puedes eliminar números pulsando sobre ellos.",
    changelog_v1310_item4: "Sincronización mejorada al crear una cuenta con Google.",
    changelog_v1310_item5: "Correcciones generales y mejoras en la estabilidad del historial de partidas.",
    changelog_v1310_item6: "Corrección en el botón de cookies.",
    ...
    sync_exclusive_desc: "Jigsudo se ha abierto en otro dispositivo o pestaña. Solo puedes tener una sesión activa para evitar pérdida de datos.",
    sync_btn_continue: "Continuar aquí 🔄",
    changelog_v137_title: "Versión 1.3.7",
    changelog_v137_date: "18/04/2026",
    changelog_v137_item1: "Precisión de Puntaje: Corregido un error de doble penalización en el puntaje diario al cometer errores.",
    changelog_v136_title: "Versión 1.3.6",
    changelog_v136_date: "18/04/2026",
    changelog_v136_item1: "Sanación de Acumuladores: Corregido un error crítico que duplicaba los puntos base en el total histórico. Se ha ejecutado una reconstrucción automática para todos los usuarios.",
    changelog_v136_item2: "Autoridad del Ranking: El sistema ahora respeta las correcciones manuales del puntaje total, evitando que contadores corruptos las sobreescriban.",
    changelog_v136_item3: "Persistencia de Reseteos: Los cambios de día ahora se guardan inmediatamente en la nube, eliminando conflictos de sincronización al cambiar de dispositivo.",
    changelog_v136_item4: "Integridad de Puntos: Refinada la lógica incremental para garantizar que cada etapa sume exactamente 1.0 RP, sin duplicados al ganar.",
    changelog_v136_item5: "Estabilidad de Sesión: Mejorado el manejo de estados locales para evitar saltos inesperados en el puntaje diario.",
    changelog_v135_title: "Versión 1.3.5",
    changelog_v135_date: "18/04/2026",
    changelog_v135_item1: "Sanación de Historial: Implementado el 'History Healer' para corregir visualmente errores de migración (como los 0 errores en récords antiguos).",
    changelog_v135_item2: "Sincronización Híbrida: El calendario ahora combina inteligentemente los datos de la nube con los locales para máxima precisión.",
    changelog_v135_item3: "Blindaje de Rankings: Mejorada la guarda de 'Victoria Tardía' para evitar que las partidas de días anteriores afecten el ranking del día actual.",
    changelog_v135_item4: "Precisión de Puntuación: Refinada la contabilidad de puntos en tiempo real para garantizar paridad total con el Árbitro en la nube.",
    changelog_v135_item5: "Ajustes Visuales: El resumen de victoria ahora muestra el puntaje con 2 decimales para una lectura más limpia.",
    changelog_v134_title: "Versión 1.3.4",
    changelog_v134_date: "17/04/2026",
    changelog_v134_item1: "Integridad de Datos: Arreglo crítico en el reseteo diario que causaba la suma accidental de puntajes de días anteriores.",
    changelog_v134_item2: "Contabilidad de Puntos: Eliminada la duplicación de puntos en el acumulador histórico (Total Score).",
    changelog_v134_item3: "Penalizaciones Reales: El ranking local ahora refleja correctamente las penalizaciones por errores, alineándose con el Árbitro en la nube.",
    changelog_v134_item4: "Victorias Tardías: Blindaje en la atribución de puntos para partidas completadas después de la medianoche, evitando conflictos de fecha.",
    changelog_v134_item5: "Sincronización Reforzada: Mejora en la resolución de conflictos para garantizar que el servidor siempre sea el Árbitro final de la verdad.",
    changelog_v133_title: "Versión 1.3.3",
    changelog_v133_date: "17/04/2026",
    changelog_v133_item1: "Diseño e Identidad: Integración de los nuevos logos V2 y fondos dinámicos.",
    changelog_v133_item2: "Estabilidad de Puntos: Múltiples arreglos en el sistema de puntuación y la penalización por inactividad (Decay).",
    changelog_v133_item3: "Lógica de Días: Mejorada la atribución de puntos cuando se gana una partida pasada la medianoche UTC.",
    changelog_v133_item4: "Formato Numérico: Los puntajes ahora se muestran con un máximo de 2 decimales, utilizando comas o puntos según el idioma local.",
    changelog_v133_item5: "Idiomas Inteligentes: La página ahora detecta el idioma del navegador y carga automáticamente en español para hispanohablantes o en inglés por defecto para el resto del mundo.",
    changelog_v133_item6: "Limpieza y Optimización: Refactorización profunda y purga de código obsoleto para mejorar el rendimiento general.",
    changelog_v132_title: "Versión 1.3.2",
    changelog_v132_date: "16/04/2026",
    changelog_v132_item1: "Arreglo Crítico de Rachas: Nueva lógica basada en el historial real de victorias, eliminando reseteos accidentales al entrar a la página.",
    changelog_v132_item2: "Integridad de Puntos: Aislamiento total del puntaje de cada sesión, evitando que se sumen puntos de días anteriores al total diario.",
    changelog_v132_item3: "Optimización de Estabilidad (OOM): Eliminación de guardados redundantes que causaban cierres inesperados en transiciones de nivel.",
  ...
  en: {
    ...
    sidebar_search_users: "Search Users",
    search_users_title: "Search Players",
    search_users_placeholder: "Type a username...",
    ...
    profile_career_score: "Career Score",
    ...
    support_title_page: "Support Center",
    support_intro: "Need help with your account, found a bug, or want to send us a suggestion? We're here to listen.",
    support_github_title: "Report Bugs and Suggestions",
    support_github_desc: "If you're a GitHub user, you can open a technical report (issue) directly in our development repository. It's the fastest way for us to see a bug or a public improvement proposal.",
    support_github_btn: "🛠️ Open GitHub Report",
    support_email_title: "Private Inquiries and Accounts",
    support_email_desc: "For account-related issues, data recovery, privacy matters, or if you prefer to contact us privately, write to us at:",
    support_email_btn: "✉️ Send an Email",
    support_donate_title: "Want to support the project?",
    support_donate_desc: "Jigsudo is and will always be free. If you enjoy the challenge and want to help us with server costs, you can buy us a coffee.",
    ...
    about_author_text: "My name is Román Yakimovicz, from Argentina, and I am a University Technician in Programming. Jigsudo is the result of my passion for puzzles, web development, and my constant curiosity to explore new challenges. Outside of coding, I am passionate about DC comics, my favorite character is Flash, and I enjoy watching series, listening to music, and gaming with friends.",
    ...
    about_github_text: "Jigsudo is a transparent project. If you're a developer or curious about how it works under the hood, you can review all the source code on <a href=\"https://github.com/ryakimovicz/jigsudo\" target=\"_blank\" style=\"color: var(--accent-color); font-weight: bold;\">GitHub</a> and even propose improvements.",
    ...
    privacy_sec3_h: "2. Cookies and Local Storage",
    privacy_sec3_p: "LocalStorage is used to save your preferences (Theme, Sound, Vibration) and keep your session active. While Jigsudo does not use its own cookies for advertising purposes, essential third-party services (such as Google Firebase or Google Tag Manager) may use technical cookies necessary for security, authentication, and basic performance analysis.",
    privacy_sec4_h: "3. Donations and Third-Party Services",
    ...
    privacy_sec5_h: "4. Your Rights",
    privacy_sec5_p1: "You have the right to access, rectify, limit, or delete your personal information, as well as request the portability of your data. You can perform most of these actions directly from your profile settings. For any other request related to your privacy rights, you can contact us at <strong>support@jigsudo.com</strong>.",

    // Cookie Consent
    cookies_title: "Cookie Settings 🍪",
    cookies_text: "We use technical and analytical cookies to improve your experience and site security.",
    cookies_btn_accept: "Accept all",
    cookies_btn_deny: "Technical only",
    cookies_link_policy: "Privacy Policy",
    ...
    stat_avg_time: "Avg Time",
    stat_points: "Points",
    stats_details_title: "Level Averages",
    ...
    btn_jigsaw_undo: "Undo",
    btn_jigsaw_redo: "Redo",
    ...
    changelog_v1423_title: "Version 1.4.23",
    changelog_v1423_date: "June 14, 2026",
    changelog_v1423_item1: "Sync: Implemented an anti-regression shield to prevent playing on out-of-sync devices from overwriting or reducing your range points (RP) or stats with lower values.",
    changelog_v1422_title: "Version 1.4.22",
    changelog_v1422_date: "May 31, 2026",
    changelog_v1422_item1: "Range Points (RP): Fixed a race condition during victory validation that caused an unintended +1.0 RP double-addition on profiles and leaderboards upon completing the puzzle.",
    changelog_v1421_title: "Version 1.4.21",
    changelog_v1421_date: "May 26, 2026",
    changelog_v1421_item1: "The Code: Implemented input click debouncing to prevent double-tap touch failures on mobile devices.",
    changelog_v1421_item2: "Range Points (RP): Fixed stats healer inconsistency that reset totalRP to monthlyRP by forcing a correct rebuild from history.",
    changelog_v1421_item3: "Profile Stats: Corrected stageTimes extraction to accurately compute historical average metrics based on actual victory data.",
    changelog_v1421_item4: "Calendar & History: Unified win validation across rendering layouts to prevent completed days from staying gray or semi-opaque.",
    changelog_v1421_item5: "Jigsaw: The reset button now preserves locked pieces in place on the board while returning unlocked pieces to their starting slots in the panel.",
    changelog_v1420_title: "Version 1.4.20",
    changelog_v1420_date: "May 22, 2026",
    changelog_v1420_item1: "Atomic Sync: Fixed dailyRP race condition via atomic verification and scoring drift correction.",
    changelog_v1419_title: "Version 1.4.19",
    changelog_v1419_date: "May 19, 2026",
    changelog_v1419_item1: "History: Fixed coloring for belated plays completed from the history page, ensuring they remain gray/yellow and only display the crown icon.",
    changelog_v1418_title: "Version 1.4.18",
    changelog_v1418_date: "May 19, 2026",
    changelog_v1418_item1: "Score Stability: Resolved 1-point local discrepancy by ensuring the final stage ('Code') base point is awarded before the victory screen.",
    changelog_v1418_item2: "Security: Fixed the NaN throne shield initialization bug by correcting GameManager's property assignment order.",
    changelog_v1418_item3: "History and Profile: Fixed background coloring (green/yellow) for older legacy entries in calendar views.",
    changelog_v1417_title: "Version 1.4.17",
    changelog_v1417_date: "May 15, 2026",
    changelog_v1417_item1: "Stability: Reinforced Jigsaw board reset to guarantee it always restores to the true initial state, even after resuming sessions.",
    changelog_v1417_item2: "Security: Implemented interaction guards to prevent tutorial events from interfering with active gameplay.",
    ...
    changelog_v149_item3: "Hotfix: Fixed an issue where yesterday's daily score was carried over to the next day during automatic reset.",
    ...
    changelog_v1112_date: "04/08/2026",
    ...
    changelog_v1119_date: "04/09/2026",
    ...
    changelog_v1118_date: "04/09/2026",
    ...
    changelog_v1117_date: "04/09/2026",
    ...
    changelog_v1116_date: "04/08/2026",
    ...
    changelog_v1115_date: "04/08/2026",
    ...
    changelog_v1114_date: "04/08/2026",
    ...
    changelog_v1113_date: "04/08/2026",
    ...
    changelog_v1111_date: "04/08/2026",
    ...
    changelog_v1110_date: "04/08/2026",
    ...
    changelog_v119_date: "04/08/2026",
    ...
    changelog_v118_date: "04/08/2026",
    ...
    changelog_v117_date: "04/08/2026",
    ...
    changelog_v116_date: "04/07/2026",
    ...
    changelog_v137_title: "Version 1.3.7",
    changelog_v137_date: "04/18/2026",
    changelog_v137_item1: "Scoring Precision: Fixed a double-penalty bug in daily scores when making errors.",
    changelog_v136_title: "Version 1.3.6",
    changelog_v136_date: "04/18/2026",
    changelog_v136_item1: "Accumulator Healing: Fixed a critical bug that double-counted base points in lifetime totals. An automatic rebuild has been triggered for all users.",
    changelog_v136_item2: "Ranking Authority: The system now respects manual corrections to total scores, preventing corrupted counters from overwriting them.",
    changelog_v136_item3: "Reset Persistence: Daily transitions are now immediately saved to the cloud, eliminating sync conflicts when switching devices.",
    changelog_v136_item4: "Point Integrity: Refined incremental logic to ensure each stage adds exactly 1.0 RP, with no duplicates upon winning.",
    changelog_v136_item5: "Session Stability: Improved local state handling to prevent unexpected jumps in daily scores.",
    changelog_v135_title: "Version 1.3.5",
    changelog_v135_date: "04/18/2026",
    changelog_v135_item1: "History Healer: Implemented a recovery mechanism to visually correct migration artifacts (such as 0 errors in legacy records).",
    changelog_v135_item2: "Hybrid Synchronization: The calendar now intelligently merges cloud and local data for maximum accuracy.",
    changelog_v135_item3: "Ranking Shield: Improved 'Late Win' guards to prevent previous days' games from affecting the current day's leaderboard.",
    changelog_v135_item4: "Score Precision: Refined real-time point accounting to ensure total parity with the Cloud Arbitrator.",
    changelog_v135_item5: "Visual Refinements: Victory summaries now display scores with 2 decimals for a cleaner look.",
    changelog_v134_title: "Version 1.3.4",
    changelog_v134_date: "04/17/2026",
    changelog_v134_item1: "Data Integrity: Critical fix for daily resets preventing accidental carryover of previous days' scores.",
    changelog_v134_item2: "Score Accounting: Eliminated double-counting of points in the lifetime accumulator (Total Score).",
    changelog_v134_item3: "Real Penalties: Local ranking now correctly reflects error penalties, aligning with the Cloud Arbitrator.",
    changelog_v134_item4: "Late Wins: Hardened point attribution for games completed after midnight UTC, preventing date conflicts.",
    changelog_v134_item5: "Reinforced Sync: Improved conflict resolution ensuring the server remains the final Arbitrator of truth.",
    changelog_v133_title: "Version 1.3.3",
    changelog_v133_date: "04/17/2026",
    changelog_v133_item1: "Design & Identity: Integrated new V2 logos and dynamic backgrounds.",
    changelog_v133_item2: "Scoring Stability: Multiple fixes to the scoring system and the inactivity penalty (Decay) logic.",
    changelog_v133_item3: "Day Transition Logic: Improved score attribution when winning a game past midnight UTC.",
    changelog_v133_item4: "Number Formatting: Scores are now displayed with a maximum of 2 decimals, using commas or dots depending on the local language.",
    changelog_v133_item5: "Smart Languages: The page now detects browser language and automatically loads in Spanish for Hispanic users, or English by default for the rest of the world.",
    changelog_v133_item6: "Cleanup & Optimization: Deep refactoring and removal of obsolete code to improve overall performance.",
    changelog_v132_title: "Version 1.3.2",
    changelog_v132_date: "04/16/2026",
    changelog_v132_item1: "Critical Streak Fix: New logic based on actual win history, eliminating accidental resets when just visiting the page.",
    ...
    changelog_v141_item2: "Penalties: Fixed inactivity penalties on old profiles.",
    changelog_v141_item3: "Comparisons: Improvements in profile comparison visualization.",
    changelog_v141_item4: "Layout Anchor: Vertical layout stabilization: titles and board now maintain a fixed position.",
    changelog_v141_item5: "Dynamic Help: Fixed help tooltips in Peaks and Number Search levels.",
    changelog_v141_item6: "UI Cleanup: Fixed visual bugs on high-resolution screens.",
    ...
    changelog_v1310_item2: "Puzzle improvements: New reset button and piece swap animations.",
    changelog_v1310_item3: "New Sudoku mechanic: Delete numbers by clicking them.",
    changelog_v1310_item4: "Enhanced account synchronization for Google logins.",
    changelog_v1310_item5: "General fixes and stability improvements for match history.",
    changelog_v1310_item6: "Fix for the cookie consent button.",
  },
};
