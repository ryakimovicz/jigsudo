export const translations = {
  es: {
    ...
    changelog_v120_item1: "Sincronización Crítica: Se ha implementado un sistema de guardado coordinado (Local + Nube) para resolver conflictos de datos al iniciar sesión en múltiples dispositivos.",
    changelog_v120_item2: "Auto-curación: El sistema ahora detecta y repara automáticamente rachas e historiales corruptos durante la sincronización.",
    changelog_v120_item3: "Infraestructura Centralizada: Migración de la lógica de puntuación a Firebase Cloud Functions para garantizar una competencia justa y blindar el ranking contra manipulaciones.",
    changelog_v120_item4: "Árbitro Centralizado: Implementación de validación atómica y anclaje de tiempo en el servidor, eliminando de forma definitiva la posibilidad de falsear tiempos de resolución.",
