export const translations = {
  es: {
    ...
    changelog_v1530_title: "Versión 1.5.30",
    changelog_v1530_date: "12/04/2026",
    changelog_v1530_item1: "Estabilidad de Privacidad: Se ha corregido un error crítico donde la configuración de perfil privado se revertía automáticamente a público tras cada partida.",
    changelog_v1530_item2: "Persistencia Atómica: El motor de base de datos ahora respeta la configuración de visibilidad del usuario durante los guardados automáticos de estadísticas.",
    changelog_v1530_item3: "Sincronización de UI: El interruptor de privacidad ahora se sincroniza instantáneamente con el estado interno del juego para garantizar una experiencia coherente.",
  ...
  en: {
    ...
    changelog_v1530_title: "Version 1.5.30",
    changelog_v1530_date: "04/12/2026",
    changelog_v1530_item1: "Privacy Stability: Fixed a critical bug where private profile settings would revert to public after each game session.",
    changelog_v1530_item2: "Atomic Persistence: The database engine now respects user visibility settings during automatic stat saves.",
    changelog_v1530_item3: "UI Synchronization: The privacy toggle now instantly syncs with the internal game state to ensure a consistent experience.",
