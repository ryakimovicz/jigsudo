export const translations = {
  es: {
    ...
    about_vision_text: "Entendemos los puzzles como una forma de ejercitar la mente y disfrutar del desafío lógico. Nuestra misión es puramente recreativa y busca ofrecer un refugio diario para desconectar del ruido cotidiano. Mantenemos Jigsudo libre de publicidad intrusiva para que nada interrumpa tu concentración.",
    ...
    privacy_sec1_p1: "Si decides crear una cuenta, utilizamos Google Firebase Authentication para gestionar tu inicio de sesión. Recopilamos tu dirección de correo electrónico y un ID de usuario único para guardar tu progreso en la nube.",
    privacy_sec1_p2: "También almacenamos tu nombre de usuario y tu preferencia de visibilidad del perfil (público o privado) en Google Firestore.",
    ...
    terms_sec2_p: "Eres responsable de mantener la confidencialidad de tu cuenta. Puedes eliminar tu cuenta y todos tus datos en cualquier momento.",
    terms_sec3_h: "3. Propiedad Intelectual",
    terms_sec3_p: "El código y diseño de Jigsudo son propiedad exclusiva de Román Yakimovicz. Todos los derechos están reservados.",
  ...
  en: {
    ...
    about_vision_text: "We understand puzzles as a way to exercise the mind and enjoy the logical challenge. Our mission is purely recreational and seeks to offer a daily refuge to disconnect from everyday noise. We keep Jigsudo free of intrusive ads so nothing interrupts your concentration.",
    ...
    privacy_sec1_p1: "If you choose to create an account, we use Google Firebase Authentication to manage your login. We collect your email address and a unique user ID to save your progress in the cloud.",
    privacy_sec1_p2: "We also store your username and profile visibility preference (public or private) in Google Firestore.",
    ...
    terms_sec2_p: "You are responsible for maintaining the confidentiality of your account. You can delete your account and all your data at any time.",
    terms_sec3_h: "3. Intellectual Property",
    terms_sec3_p: "The code and design of Jigsudo are the exclusive property of Román Yakimovicz. All rights reserved.",
