export const translations = {
  es: {
    ...
    changelog_v1120_title: "Versión 1.1.20",
    changelog_v1120_date: "09/04/2026",
    changelog_v1120_item1: "Sincronización Crítica: Se ha implementado un sistema de guardado coordinado (Local + Nube) para resolver conflictos de datos al iniciar sesión en múltiples dispositivos.",
    changelog_v1120_item2: "Auto-curación: El sistema ahora detecta y repara automáticamente rachas e historiales corruptos durante la sincronización.",
  ...
  en: {
    ...
    changelog_v1120_title: "Version 1.1.20",
    changelog_v1120_date: "04/09/2026",
    changelog_v1120_item1: "Critical Synchronization: Implemented a coordinated save system (Local + Cloud) to resolve data conflicts when logging in on multiple devices.",
    changelog_v1120_item2: "Self-Healing: The system now automatically detects and repairs corrupted streaks and histories during synchronization.",
