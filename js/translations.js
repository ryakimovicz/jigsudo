export const translations = {
  es: {
    ...
    about_vision_text: "Entendemos los puzzles como una forma de ejercitar la mente y disfrutar del desafío lógico. Nuestra misión es recreativa y busca ofrecer un refugio diario para desconectar del ruido cotidiano. Mantenemos Jigsudo 100% libre de publicidad para que nada interrumpa tu concentración.",
    ...
    privacy_intro_text: "Tu privacidad es importante para nosotros. Esta Política de Privacidad explica cómo recopilamos, usamos y protegemos tu información cuando utilizas nuestra aplicación web.",
    privacy_sec1_h: "1. Información que Recopilamos",
    privacy_sec1_sub1: "1.1. Autenticación y Perfil",
    privacy_sec1_p1: "Si decides crear una cuenta, utilizamos <strong>Google Firebase Authentication</strong> para gestionar tu inicio de sesión. Recopilamos tu dirección de correo electrónico y un ID de usuario único para guardar tu progreso en la nube.",
    privacy_sec1_p2: "También almacenamos tu nombre de usuario y tu preferencia de visibilidad del perfil (público o privado) en <strong>Google Firestore</strong>.",
    privacy_sec2_h: "2. Datos de Juego",
    privacy_sec2_p: "Almacenamos tu progreso en las partidas (tiempos, puntuaciones, estado del tablero) para que puedas continuar desde cualquier dispositivo y participar en las clasificaciones.",
    ...
    privacy_sec3_p: "Utilizamos LocalStorage para guardar tus preferencias (Tema, Sonido, Vibración) y mantener tu sesión iniciada. Jigsudo no utiliza cookies de publicidad ni de rastreo de terceros.",
    privacy_sec4_h: "4. Donaciones y Servicios de Terceros",
    privacy_sec4_p: "Para el apoyo económico del proyecto, utilizamos plataformas externas como Ko-fi y Cafecito. Estos servicios tienen sus propias políticas de privacidad sobre cómo gestionan tus datos de pago.",
    ...
    privacy_sec5_p2: "Para consultas adicionales sobre tus datos, puedes contactarnos a través de nuestra página de contacto.",
    support_title: "Apoya el Proyecto",
    support_desc: "Si disfrutas de Jigsudo y quieres que siga siendo gratuito y sin publicidad, puedes invitarnos un café.",
    ...
    seo_faq_8_a: "Jigsudo no tiene micro-pagos y el acceso es gratuito. El proyecto se mantiene de forma independiente, no contiene publicidad y acepta donaciones opcionales para sustentar los costos.",
    terms_intro_text: "Bienvenido a Jigsudo. Al acceder o utilizar nuestro sitio web, aceptas cumplir con estos Términos y Condiciones. Si no estás de acuerdo con alguna parte, no deberías utilizar el servicio.",
    ...
    terms_sec4_p: "Las donaciones son voluntarias y no otorgan ventajas competitivas en el juego. Se procesan a través de proveedores externos.",
    ...
    terms_sec6_p: "El servicio se proporciona 'tal cual'. No garantizamos que sea ininterrumpido o libre de errores. No seremos responsables por daños derivados del uso del servicio.",
    ...
    contact_talk_p1: "¿Tienes sugerencias, encontraste un error, o simplemente quieres dejarnos tus comentarios sobre Jigsudo? Estaremos encantados de leerte.",
    contact_talk_p2: "Puedes ponerte en contacto directamente con nuestro equipo de desarrollo creando un reporte en nuestra plataforma de soporte:",
    contact_talk_p3: "Allí podrás abrir un 'Issue' (reporte) y te responderemos a la brevedad.",
  ...
  en: {
    ...
    contact_talk_p1: "Got suggestions, found a bug, or just want to leave feedback? We'd love to hear from you.",
    contact_talk_p2: "You can get in touch with our development team by creating a ticket on our support platform:",
    contact_talk_p3: "There you can open an 'Issue' and we'll get back to you as soon as possible.",
    ...
    about_vision_text: "We see puzzles as a way to exercise the mind and enjoy a logical challenge. Our mission is recreational, seeking to offer a daily refuge to disconnect from everyday noise. We keep Jigsudo 100% ad-free so nothing interrupts your concentration.",
    ...
    privacy_intro_text: "Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your information when you use our web application.",
    privacy_sec1_h: "1. Information We Collect",
    privacy_sec1_sub1: "1.1. Authentication and Profile",
    privacy_sec1_p1: "If you choose to create an account, we use <strong>Google Firebase Authentication</strong> to manage your login. We collect your email address and a unique user ID to save your progress in the cloud.",
    privacy_sec1_p2: "We also store your username and profile visibility preference (public or private) in <strong>Google Firestore</strong>.",
    privacy_sec2_h: "2. Game Data",
    privacy_sec2_p: "We store your game progress (times, scores, board state) so you can continue from any device and participate in global rankings.",
    ...
    privacy_sec3_p: "We use your browser's LocalStorage to save your preferences (Theme, Sound, Vibration) and keep your session active. Jigsudo does not use advertising or third-party tracking cookies.",
    privacy_sec4_h: "4. Donations and Third-Party Services",
    privacy_sec4_p: "For financial support of the project, we use external platforms such as Ko-fi and Cafecito. These services have their own privacy policies regarding how they handle your payment data.",
    ...
    privacy_sec5_p2: "For additional inquiries about your data, you can contact us through our contact page.",
    support_title: "Support the Project",
    support_desc: "If you enjoy Jigsudo and want to keep it free and ad-free, you can buy us a coffee.",
    support_argentina: "Argentina (MP)",
    support_global: "Global (PayPal)",
    ...
    seo_faq_8_a: "Jigsudo has no micro-payments and access is free. The project is maintained independently, contains no advertising, and accepts optional donations to support the costs.",
    terms_intro_text: "Welcome to Jigsudo. By accessing or using our website, you agree to comply with these Terms and Conditions. If you do not agree with any part, you should not use the service.",
    ...
    terms_sec4_p: "Donations are voluntary and do not grant competitive advantages in the game. They are processed through third-party providers.",
    ...
    terms_sec6_p: "The service is provided 'as is'. We do not guarantee it will be uninterrupted or error-free. We will not be liable for damages arising from the use of the service.",
