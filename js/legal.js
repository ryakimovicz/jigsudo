...
import { initLanguage, getCurrentLang } from "./i18n.js?v=1.3.6";
import { initSidebar, closeSidebar } from "./sidebar.js?v=1.3.6";
...
import { getRankData } from "./ranks.js?v=1.3.6";
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.3.6";
...
function initAuthListener() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (!isGuest && user) {
        import("./db.js?v=1.3.6").then(({ callJigsudoFunction }) => {
