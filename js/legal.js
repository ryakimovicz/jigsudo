...
import { initLanguage, getCurrentLang } from "./i18n.js?v=1.3.5";
import { initSidebar, closeSidebar } from "./sidebar.js?v=1.3.5";
...
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.3.5";
...
function initAuthListener() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (!isGuest && user) {
        import("./db.js?v=1.3.5").then(({ callJigsudoFunction }) => {
