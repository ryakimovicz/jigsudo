...
import { initLanguage, getCurrentLang } from "./i18n.js?v=1.2.2";
import { initSidebar, closeSidebar } from "./sidebar.js?v=1.2.2";
...
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.2.2";
...
function initAuthListener() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (!isGuest && user) {
        import("./db.js?v=1.2.2").then(({ callJigsudoFunction }) => {
