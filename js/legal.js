...
import { initSidebar, closeSidebar } from "./sidebar.js?v=1.3.1";
...
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.3.1";
...
function initAuthListener() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (!isGuest && user) {
        import("./db.js?v=1.3.1").then(({ callJigsudoFunction }) => {
