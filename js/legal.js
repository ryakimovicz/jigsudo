...
import { initLanguage, getCurrentLang } from "./i18n.js?v=1.5.55";
import { initSidebar, closeSidebar } from "./sidebar.js?v=1.5.55";
...
import { getRankData } from "./ranks.js?v=1.5.55";
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.5.55";
...
function initAuthListener() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (!isGuest && user) {
        import("./db.js?v=1.5.55").then(({ callJigsudoFunction }) => {
