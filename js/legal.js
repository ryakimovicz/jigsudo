...
import { initLanguage, getCurrentLang } from "./i18n.js?v=1.1.17";
import { closeSidebar } from "./sidebar.js?v=1.1.17";
...
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.1.17";
