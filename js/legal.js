...
import { initLanguage, getCurrentLang } from "./i18n.js?v=1.4.17";
import { initSidebar, closeSidebar } from "./sidebar.js?v=1.4.17";
...
import { loginUser, registerUser, loginWithGoogle, initForgotPasswordUI } from "./auth.js?v=1.4.17";
...
function initAuthListener() {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (!isGuest && user) {
        import("./db.js?v=1.4.17").then(({ callJigsudoFunction }) => {
