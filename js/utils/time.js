...
export function getJigsudoDate() {
  if (CONFIG.isDemo && CONFIG.demoDate) {
    // Return the fixed demo date (as a Date object at noon UTC to avoid edge case issues)
    return new Date(CONFIG.demoDate + "T12:00:00Z");
  }
