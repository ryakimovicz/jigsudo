...
import { initGuide, openTutorialModal } from "./guide.js?v=1.3.9"; // Guide & Tutorial Import
...
import {
  ...
  logoutUser,
  loginWithGoogle,
} from "./auth.js?v=1.3.9"; // Auth Import
import { initProfile, showProfile } from "./profile.js?v=1.3.9"; // Profile Import
import { CONFIG } from "./config.js?v=1.3.9"; // Keep CONFIG for displayVersion
import { router } from "./router.js?v=1.3.9"; // Router Import
import { closeSidebar, initSidebar } from "./sidebar.js?v=1.3.9";
import { initChangelog } from "./changelog.js?v=1.3.9";
import { toggleModal } from "./ui.js?v=1.3.9";
import { isAtGameRoute } from "./utils/route-utils.js?v=1.3.9";
import { checkSeasonMigration } from "./migration.js?v=1.3.9";
...
async function checkForUpdates() {
  try {
    ...
    if (serverVersion && isNewerVersion(serverVersion, localVersion)) {
      ...
      const { showUpdateToast } = await import("./ui.js?v=1.3.9");
...
async function startApp() {
  ...
  if (CONFIG.debugMode) {
    ...
    window.magicWand = async () => {
      const { debugAutoMatch } = await import("./memory.js?v=1.3.9");
