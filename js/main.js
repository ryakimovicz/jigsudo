...
import { initHome } from "./home.js?v=1.1.19";
import { initLanguage } from "./i18n.js?v=1.1.19";
import { initSudoku } from "./sudoku.js?v=1.1.19";
import { initHistory } from "./history.js?v=1.1.19";
import { initGuide, openTutorialModal } from "./guide.js?v=1.1.19"; // Guide & Tutorial Import
...
import {
  ...
  logoutUser,
  loginWithGoogle,
} from "./auth.js?v=1.1.19"; // Auth Import
import { initProfile, showProfile } from "./profile.js?v=1.1.19"; // Profile Import
import { CONFIG } from "./config.js?v=1.1.19"; // Keep CONFIG for displayVersion
import { router } from "./router.js?v=1.1.19"; // Router Import
import { closeSidebar, initSidebar } from "./sidebar.js?v=1.1.19";
import { initChangelog } from "./changelog.js?v=1.1.19";
import { toggleModal } from "./ui.js?v=1.1.19";
import { isAtGameRoute } from "./utils/route-utils.js?v=1.1.19";
...
async function checkForUpdates() {
  try {
    ...
    if (serverVersion && isNewerVersion(serverVersion, localVersion)) {
      ...
      const { showUpdateToast } = await import("./ui.js?v=1.1.19");
