...
import { generateDailyGame } from "../js/sudoku-logic.js?v=1.2.0";
import { getAllTargets } from "../js/peaks-logic.js?v=1.2.0";
import { getJigsudoDate } from "../js/utils/time.js?v=1.2.0";
