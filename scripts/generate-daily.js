...
import { generateDailyGame } from "../js/sudoku-logic.js?v=1.1.7";
import { getAllTargets } from "../js/peaks-logic.js?v=1.1.7";
import { getJigsudoDate } from "../js/utils/time.js?v=1.1.7";
