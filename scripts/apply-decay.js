...
import { getJigsudoDateString } from "../js/utils/time.js?v=1.2.2"; // Uses Jigsudo offset handling
import { getRankData } from "../js/ranks.js?v=1.2.2"; // Uses dynamic bounds for decay penalty
