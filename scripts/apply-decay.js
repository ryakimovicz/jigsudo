...
import { getJigsudoDateString, getJigsudoDayDiff } from "../js/utils/time.js?v=1.3.7"; // Uses Jigsudo offset handling
import { getRankData } from "../js/ranks.js?v=1.3.7"; // Uses dynamic bounds for decay penalty
