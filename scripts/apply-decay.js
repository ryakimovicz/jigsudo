...
import { getJigsudoDateString, getJigsudoDayDiff } from "../js/utils/time.js?v=1.3.10"; // Uses Jigsudo offset handling
import { getRankData } from "../js/ranks.js?v=1.3.10"; // Uses dynamic bounds for decay penalty
